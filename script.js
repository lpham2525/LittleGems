  ...
  function retrieveSaved () {
    ...
    for (i = 0; i < favoriteArray.length; i++) {
      ...
      $.ajax({
        ...
        url: `https://developers.zomato.com/api/v2.1/restaurant?res_id=${favoriteArray[i]}`, // what you want
        dataType: 'json', // wanted response data type - let jQuery handle the rest...
        data: {
          // could be directly in URL, but this is more pretty, clear and easier to edit
        },
        ...
        success: function (data) {
          ...
          // Checks if restaurant has photo or not. If it does, then sets img source to that; if it doesn't, then sets img source to placeholder
